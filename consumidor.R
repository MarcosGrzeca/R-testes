...
rules <- apriori(dados, parameter = list(minlen=2, supp=0.16, conf=0.4, maxtime =20), appearance = list(rhs=c("media=C"), default="lhs"), control = list(verbose=F))
